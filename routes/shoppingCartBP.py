...
from controllers.shoppingCartController import add_item_to_cart, remove_item_from_cart, update_item_quantity, get_shopping_cart, empty_shopping_cart
...
shopping_cart_blueprint.route('/', methods=['GET'])(get_shopping_cart)
